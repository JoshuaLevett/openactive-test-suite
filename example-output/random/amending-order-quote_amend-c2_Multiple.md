[< Return to Summary](summary.md) | File Generated: Fri Sep 11 2020 10:34:10 GMT+0000 (Coordinated Universal Time)
...
⚠️ 22 passed with 0 failures, 316 warnings and 120 suggestions 
...
Response status code: 200 OK. Responded in 56.32258ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/12/events/127"
}
```
...
Response status code: 200 OK. Responded in 32.43321ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/5/events/54"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F12%2Fevents%2F127?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 18.224411ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-19T13:05:26+00:00",
    "endDate": "2020-09-19T17:34:26+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F5%2Fevents%2F54?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 17.687396ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/5",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/5#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 0,
    ...
    "startDate": "2020-09-14T11:06:55+00:00",
    "endDate": "2020-09-14T12:58:55+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8baf21d8-b53a-55b2-8535-9af64b24e163

---

Response status code: 200 OK. Responded in 56.220465ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8baf21d8-b53a-55b2-8535-9af64b24e163",
...
Response status code: 200 OK. Responded in 23.428653ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/8/events/87"
}
```
...
Response status code: 200 OK. Responded in 7.413907ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/38/events/380"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F8%2Fevents%2F87?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 7.733415ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-17T04:00:32+00:00",
    "endDate": "2020-09-17T07:38:32+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F38%2Fevents%2F380?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 7.134598ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/38",
      "name": "Steel Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/38#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 0,
    ...
    "startDate": "2020-09-18T00:54:36+00:00",
    "endDate": "2020-09-18T01:35:36+00:00"
  }
}
```
### Specs
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8baf21d8-b53a-55b2-8535-9af64b24e163

---

Response status code: 200 OK. Responded in 86.029678ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/38"
        },
        "maximumAttendeeCapacity": 27,
        "remainingAttendeeCapacity": 27,
        "startDate": "2020-09-18T00:54:36+00:00",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/8baf21d8-b53a-55b2-8535-9af64b24e163

---

Response status code: 200 OK. Responded in 66.454837ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/8baf21d8-b53a-55b2-8535-9af64b24e163",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8baf21d8-b53a-55b2-8535-9af64b24e163#/orderedItems/28",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/8#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8baf21d8-b53a-55b2-8535-9af64b24e163#/orderedItems/29",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/8#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8baf21d8-b53a-55b2-8535-9af64b24e163#/orderedItems/30",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/38#/offers/0",
        "price": 0,
