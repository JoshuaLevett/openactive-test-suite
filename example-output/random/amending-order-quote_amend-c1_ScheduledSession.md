...
⚠️ 11 passed with 0 failures, 116 warnings and 40 suggestions 
...
Response status code: 200 OK. Responded in 233.54635ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/46/events/467"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F46%2Fevents%2F467?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 64.63564ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-13T16:28:31+00:00",
    "endDate": "2020-09-13T19:59:31+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1eb8b980-185d-53f2-bf77-c5f2cf4cef42

---

Response status code: 200 OK. Responded in 503.257228ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1eb8b980-185d-53f2-bf77-c5f2cf4cef42",
...
Response status code: 200 OK. Responded in 19.596353ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/33/events/336"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F33%2Fevents%2F336?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 6.531885ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-20T08:50:46+00:00",
    "endDate": "2020-09-20T12:25:46+00:00"
  }
}
```
### Specs
...
Response status code: 200 OK. Responded in 28.410003ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1eb8b980-185d-53f2-bf77-c5f2cf4cef42

---

Response status code: 200 OK. Responded in 69.197241ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:13+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1eb8b980-185d-53f2-bf77-c5f2cf4cef42

---

Response status code: 200 OK. Responded in 189.919727ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1eb8b980-185d-53f2-bf77-c5f2cf4cef42",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1eb8b980-185d-53f2-bf77-c5f2cf4cef42#/orderedItems/5",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/33#/offers/0",
        "price": 0,
