[< Return to Summary](summary.md) | File Generated: Fri Sep 11 2020 10:34:25 GMT+0000 (Coordinated Universal Time)
...
⚠️ 9 passed with 0 failures, 200 warnings and 78 suggestions 
...
Response status code: 200 OK. Responded in 26.489081ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/85/events/857"
}
```
...
Response status code: 200 OK. Responded in 25.820964ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/70/events/709"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/b558c078-7ade-5f44-9128-46d577edfb37

---

Response status code: 204 No Content. Responded in 61.329268ms

## Get Opportunity Feed Items

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F85%2Fevents%2F857?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 19.918512ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-19T16:52:27+00:00",
    "endDate": "2020-09-19T21:24:27+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F70%2Fevents%2F709?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 19.4538ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "maximumAttendeeCapacity": 27,
    "remainingAttendeeCapacity": 27,
    "startDate": "2020-09-21T06:38:53+00:00",
    "endDate": "2020-09-21T07:30:53+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b558c078-7ade-5f44-9128-46d577edfb37

---

Response status code: 200 OK. Responded in 54.013488ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b558c078-7ade-5f44-9128-46d577edfb37",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b558c078-7ade-5f44-9128-46d577edfb37

---

Response status code: 200 OK. Responded in 76.302761ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:27+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b558c078-7ade-5f44-9128-46d577edfb37

---

Response status code: 200 OK. Responded in 87.931448ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b558c078-7ade-5f44-9128-46d577edfb37",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b558c078-7ade-5f44-9128-46d577edfb37#/orderedItems/73",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/85#/offers/0",
        "price": 19.75,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b558c078-7ade-5f44-9128-46d577edfb37#/orderedItems/74",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/85#/offers/0",
        "price": 19.75,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b558c078-7ade-5f44-9128-46d577edfb37#/orderedItems/75",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/70#/offers/0",
        "price": 0,
