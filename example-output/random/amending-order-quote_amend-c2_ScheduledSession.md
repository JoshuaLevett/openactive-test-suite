...
Response status code: 200 OK. Responded in 181.55317ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/56/events/561"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F56%2Fevents%2F561?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 51.482866ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-14T10:42:04+00:00",
    "endDate": "2020-09-14T13:38:04+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/dd19846b-fb4c-597d-a6e2-42111f2c3415

---

Response status code: 200 OK. Responded in 580.66091ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/dd19846b-fb4c-597d-a6e2-42111f2c3415",
...
Response status code: 200 OK. Responded in 26.402441ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/75/events/757"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F75%2Fevents%2F757?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 3.682204ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-21T06:06:54+00:00",
    "endDate": "2020-09-21T09:07:54+00:00"
  }
}
```
### Specs
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/dd19846b-fb4c-597d-a6e2-42111f2c3415

---

Response status code: 200 OK. Responded in 61.380321ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/dd19846b-fb4c-597d-a6e2-42111f2c3415

---

Response status code: 200 OK. Responded in 127.837785ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/dd19846b-fb4c-597d-a6e2-42111f2c3415",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/dd19846b-fb4c-597d-a6e2-42111f2c3415#/orderedItems/7",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/75#/offers/0",
        "price": 16.79,
