...
Response status code: 200 OK. Responded in 78.830549ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/15/events/155"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/3a3e85d1-8521-5551-a7bb-29bf626530bc

---

Response status code: 204 No Content. Responded in 54.754656ms

## Get Opportunity Feed Items

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F15%2Fevents%2F155?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 12.413638ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/15",
      "name": "Rubber Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/15#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-09-16T17:21:09+00:00",
    "endDate": "2020-09-16T22:34:09+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3a3e85d1-8521-5551-a7bb-29bf626530bc

---

Response status code: 200 OK. Responded in 34.488034ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3a3e85d1-8521-5551-a7bb-29bf626530bc",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3a3e85d1-8521-5551-a7bb-29bf626530bc

---

Response status code: 200 OK. Responded in 64.115436ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:18+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/3a3e85d1-8521-5551-a7bb-29bf626530bc

---

Response status code: 200 OK. Responded in 70.764216ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/3a3e85d1-8521-5551-a7bb-29bf626530bc",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3a3e85d1-8521-5551-a7bb-29bf626530bc#/orderedItems/38",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/15#/offers/0",
        "price": 0,
...
### get-order Request
GET http://localhost:3000/get-order/3a3e85d1-8521-5551-a7bb-29bf626530bc

---

Response status code: 200 OK. Responded in 2603.2828289999998ms
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "3a3e85d1-8521-5551-a7bb-29bf626530bc",
  "modified": 637354172590835100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/3a3e85d1-8521-5551-a7bb-29bf626530bc",
    "identifier": "3a3e85d1-8521-5551-a7bb-29bf626530bc",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/3a3e85d1-8521-5551-a7bb-29bf626530bc#/orderedItems/38",
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/3a3e85d1-8521-5551-a7bb-29bf626530bc

---

Response status code: 204 No Content. Responded in 164.909851ms
### Specs
