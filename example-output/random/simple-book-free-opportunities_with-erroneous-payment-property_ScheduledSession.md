...
Response status code: 200 OK. Responded in 70.563076ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/45/events/457"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F45%2Fevents%2F457?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 21.83518ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-15T14:06:43+00:00",
    "endDate": "2020-09-15T17:16:43+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/afe662c7-2e0a-56f6-bf0f-3f75890571ad

---

Response status code: 200 OK. Responded in 63.897688ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/afe662c7-2e0a-56f6-bf0f-3f75890571ad",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/afe662c7-2e0a-56f6-bf0f-3f75890571ad

---

Response status code: 200 OK. Responded in 72.376612ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:22+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/afe662c7-2e0a-56f6-bf0f-3f75890571ad

---

Response status code: 400 Bad Request. Responded in 65.661934ms
```json
{
  "@context": "https://openactive.io/",
