[< Return to Summary](summary.md) | File Generated: Fri Sep 11 2020 10:34:11 GMT+0000 (Coordinated Universal Time)
...
⚠️ 20 passed with 0 failures, 353 warnings and 138 suggestions 
...
Response status code: 200 OK. Responded in 5.76916ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/61/events/619"
}
```
...
Response status code: 200 OK. Responded in 5.431451ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/33/events/338"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F61%2Fevents%2F619?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 13.601779ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-15T20:42:12+00:00",
    "endDate": "2020-09-15T21:17:12+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F33%2Fevents%2F338?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 13.065863ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-14T12:27:00+00:00",
    "endDate": "2020-09-14T15:39:00+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f35a6224-e9a5-5cf4-aadb-bbb217c2deff

---

Response status code: 200 OK. Responded in 61.219804ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f35a6224-e9a5-5cf4-aadb-bbb217c2deff",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/33"
        },
        "maximumAttendeeCapacity": 1,
        "remainingAttendeeCapacity": 1,
        "startDate": "2020-09-14T12:27:00+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f35a6224-e9a5-5cf4-aadb-bbb217c2deff

---

Response status code: 200 OK. Responded in 71.216469ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:15+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
Response status code: 200 OK. Responded in 27.358356ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/28/events/282"
}
```
...
Response status code: 200 OK. Responded in 26.707339ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/4/events/47"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F28%2Fevents%2F282?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 13.984387ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/28",
      "name": "Soft Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/28#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 15.75,
    ...
    "startDate": "2020-09-12T09:53:53+00:00",
    "endDate": "2020-09-12T12:13:53+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F4%2Fevents%2F47?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 13.404771ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-12T07:21:08+00:00",
    "endDate": "2020-09-12T09:10:08+00:00"
  }
}
```
### Specs
...
Response status code: 200 OK. Responded in 150.661465ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/28"
        },
        "maximumAttendeeCapacity": 40,
        "remainingAttendeeCapacity": 40,
        "startDate": "2020-09-12T09:53:53+00:00",
...
Response status code: 200 OK. Responded in 90.810293ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:16+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f35a6224-e9a5-5cf4-aadb-bbb217c2deff

---

Response status code: 200 OK. Responded in 79.04197ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f35a6224-e9a5-5cf4-aadb-bbb217c2deff",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f35a6224-e9a5-5cf4-aadb-bbb217c2deff#/orderedItems/34",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/28#/offers/0",
        "price": 15.75,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f35a6224-e9a5-5cf4-aadb-bbb217c2deff#/orderedItems/35",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/28#/offers/0",
        "price": 15.75,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f35a6224-e9a5-5cf4-aadb-bbb217c2deff#/orderedItems/36",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/4#/offers/0",
        "price": 17.7,
