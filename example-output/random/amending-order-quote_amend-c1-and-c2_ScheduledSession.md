...
⚠️ 10 passed with 0 failures, 133 warnings and 46 suggestions 
...
Response status code: 200 OK. Responded in 163.187446ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/46/events/460"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F46%2Fevents%2F460?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 54.975765ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-16T09:44:32+00:00",
    "endDate": "2020-09-16T15:28:32+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e254376e-fdbc-50c0-b65f-0227d982176e

---

Response status code: 200 OK. Responded in 581.557742ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e254376e-fdbc-50c0-b65f-0227d982176e",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e254376e-fdbc-50c0-b65f-0227d982176e

---

Response status code: 200 OK. Responded in 258.06948ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:12+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
Response status code: 200 OK. Responded in 4.349822ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/57/events/579"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F57%2Fevents%2F579?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 3.406896ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-16T21:34:40+00:00",
    "endDate": "2020-09-17T03:05:40+00:00"
  }
}
```
### Specs
...
Response status code: 200 OK. Responded in 119.167942ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 75.24991ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e254376e-fdbc-50c0-b65f-0227d982176e

---

Response status code: 200 OK. Responded in 62.671655ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e254376e-fdbc-50c0-b65f-0227d982176e",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e254376e-fdbc-50c0-b65f-0227d982176e#/orderedItems/9",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/57#/offers/0",
        "price": 0,
