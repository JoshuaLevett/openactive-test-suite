...
Response status code: 200 OK. Responded in 9.146946ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/28/events/285"
}
```
...
Response status code: 200 OK. Responded in 8.439127ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F28%2Fevents%2F285?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 3.788102ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-15T09:56:36+00:00",
    "endDate": "2020-09-15T11:03:36+00:00"
  }
}
```
...
Response status code: 200 OK. Responded in 9.824065ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-16T21:45:11+00:00",
    "endDate": "2020-09-16T22:42:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d95528b4-b7f1-5b5b-8214-073e9cbb4512

---

Response status code: 409 Conflict. Responded in 43.82798ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d95528b4-b7f1-5b5b-8214-073e9cbb4512",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d95528b4-b7f1-5b5b-8214-073e9cbb4512

---

Response status code: 409 Conflict. Responded in 36.934988ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
