...
⚠️ 25 passed with 0 failures, 312 warnings and 120 suggestions 
...
Response status code: 200 OK. Responded in 40.64154ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/45/events/455"
}
```
...
Response status code: 200 OK. Responded in 39.924219ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/57/events/570"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F45%2Fevents%2F455?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 8.003124ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-20T00:19:40+00:00",
    "endDate": "2020-09-20T05:44:40+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F57%2Fevents%2F570?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 7.360307ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-11T21:21:53+00:00",
    "endDate": "2020-09-11T22:41:53+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/94664769-dc8d-5a20-8f07-4e5969cb0b38

---

Response status code: 200 OK. Responded in 60.153087ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/94664769-dc8d-5a20-8f07-4e5969cb0b38",
...
Response status code: 200 OK. Responded in 24.74809ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/78/events/781"
}
```
...
Response status code: 200 OK. Responded in 11.906431ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/57/events/577"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F78%2Fevents%2F781?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 6.139971ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-12T09:44:29+00:00",
    "endDate": "2020-09-12T14:55:29+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F57%2Fevents%2F577?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 5.586356ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-15T20:21:31+00:00",
    "endDate": "2020-09-16T01:21:31+00:00"
  }
}
```
### Specs
...
Response status code: 200 OK. Responded in 77.905869ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/94664769-dc8d-5a20-8f07-4e5969cb0b38

---

Response status code: 200 OK. Responded in 73.152826ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/94664769-dc8d-5a20-8f07-4e5969cb0b38

---

Response status code: 200 OK. Responded in 94.868023ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/94664769-dc8d-5a20-8f07-4e5969cb0b38",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/94664769-dc8d-5a20-8f07-4e5969cb0b38#/orderedItems/25",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/78#/offers/0",
        "price": 1.89,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/94664769-dc8d-5a20-8f07-4e5969cb0b38#/orderedItems/26",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/78#/offers/0",
        "price": 1.89,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/94664769-dc8d-5a20-8f07-4e5969cb0b38#/orderedItems/27",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/57#/offers/0",
        "price": 0,
