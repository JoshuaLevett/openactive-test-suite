...
Response status code: 200 OK. Responded in 15.075499ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/82/events/826"
}
```
...
Response status code: 200 OK. Responded in 14.484983ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/82/events/827"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F82%2Fevents%2F826?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 17.874072ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/82",
      "name": "Metal Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/82#/offers/0",
          "availableChannel": [
    ...
    "startDate": "2020-09-13T00:47:41+00:00",
    "endDate": "2020-09-13T06:21:41+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F82%2Fevents%2F827?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 17.491762ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-21T01:18:14+00:00",
    "endDate": "2020-09-21T04:12:14+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1ab2334a-ae7f-53ca-9659-78a425af3b77

---

Response status code: 200 OK. Responded in 63.046956ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1ab2334a-ae7f-53ca-9659-78a425af3b77",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/82"
        },
        "maximumAttendeeCapacity": 50,
        "remainingAttendeeCapacity": 50,
        "startDate": "2020-09-13T00:47:41+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1ab2334a-ae7f-53ca-9659-78a425af3b77

---

Response status code: 200 OK. Responded in 116.122351ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:23+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1ab2334a-ae7f-53ca-9659-78a425af3b77

---

Response status code: 400 Bad Request. Responded in 85.115824ms
```json
{
  "@context": "https://openactive.io/",
