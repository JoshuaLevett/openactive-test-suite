...
Response status code: 200 OK. Responded in 55.276707ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/32/events/324"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F32%2Fevents%2F324?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 11.080302ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-21T07:10:57+00:00",
    "endDate": "2020-09-21T12:07:57+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5f23087c-fa58-591a-9477-47d3cddb8327

---

Response status code: 400 Bad Request. Responded in 27.085239ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 4.419421ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 3.514396ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-18T18:21:10+00:00",
    "endDate": "2020-09-18T19:05:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ce916d8e-5c43-51a2-9c20-68922ecf7360

---

Response status code: 200 OK. Responded in 45.76714ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ce916d8e-5c43-51a2-9c20-68922ecf7360",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ce916d8e-5c43-51a2-9c20-68922ecf7360

---

Response status code: 400 Bad Request. Responded in 25.782599ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
...
Response status code: 200 OK. Responded in 4.217114ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 6.940988ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-17T23:59:51+00:00",
    "endDate": "2020-09-18T04:34:51+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7b77a8c7-84cb-5eb6-9b52-002b67868f6d

---

Response status code: 200 OK. Responded in 36.063177ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7b77a8c7-84cb-5eb6-9b52-002b67868f6d",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7b77a8c7-84cb-5eb6-9b52-002b67868f6d

---

Response status code: 200 OK. Responded in 27.262538ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7b77a8c7-84cb-5eb6-9b52-002b67868f6d

---

Response status code: 400 Bad Request. Responded in 55.07089ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
