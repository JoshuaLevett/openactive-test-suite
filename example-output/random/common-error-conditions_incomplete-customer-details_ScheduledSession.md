...
Response status code: 200 OK. Responded in 122.954452ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/56/events/562"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F56%2Fevents%2F562?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 11.075002ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-16T10:56:55+00:00",
    "endDate": "2020-09-16T12:38:55+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/587a1bf4-a71b-5295-9098-7157124652b9

---

Response status code: 200 OK. Responded in 56.246124ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/587a1bf4-a71b-5295-9098-7157124652b9",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/587a1bf4-a71b-5295-9098-7157124652b9

---

Response status code: 400 Bad Request. Responded in 52.155813ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 5.378946ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/9/events/98"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F9%2Fevents%2F98?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 13.991479ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-20T11:45:35+00:00",
    "endDate": "2020-09-20T15:19:35+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/aa045fea-11b1-5d9b-b81e-b9f94a4fd124

---

Response status code: 200 OK. Responded in 33.007694ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/aa045fea-11b1-5d9b-b81e-b9f94a4fd124",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/aa045fea-11b1-5d9b-b81e-b9f94a4fd124

---

Response status code: 200 OK. Responded in 106.236278ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/aa045fea-11b1-5d9b-b81e-b9f94a4fd124

---

Response status code: 400 Bad Request. Responded in 30.722927ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
