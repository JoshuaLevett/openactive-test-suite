[< Return to Summary](summary.md) | File Generated: Fri Sep 11 2020 10:34:17 GMT+0000 (Coordinated Universal Time)
...
⚠️ 24 passed with 0 failures, 336 warnings and 126 suggestions 
...
Response status code: 200 OK. Responded in 7.530502ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/89/events/899"
}
```
...
Response status code: 200 OK. Responded in 6.988888ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/33/events/335"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F89%2Fevents%2F899?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 5.94576ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-17T15:57:35+00:00",
    "endDate": "2020-09-17T16:41:35+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F33%2Fevents%2F335?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 5.423046ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/33",
      "name": "Frozen Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/33#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 0,
    ...
    "startDate": "2020-09-19T09:26:10+00:00",
    "endDate": "2020-09-19T12:45:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0f924143-aff8-5579-82f1-838978eb9524

---

Response status code: 400 Bad Request. Responded in 44.027485ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 12.936748ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/45/events/459"
}
```
...
Response status code: 200 OK. Responded in 14.099679ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/85/events/854"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F45%2Fevents%2F459?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 5.472548ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/45",
      "name": "Rubber Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/45#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 0,
    ...
    "startDate": "2020-09-18T08:49:07+00:00",
    "endDate": "2020-09-18T12:47:07+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F85%2Fevents%2F854?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 5.640152ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/85",
      "name": "Plastic Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/85#/offers/0",
          "availableChannel": [
            "https://openactive.io/OpenBookingPrepayment"
          ],
          "price": 19.75,
    ...
    "startDate": "2020-09-19T03:11:19+00:00",
    "endDate": "2020-09-19T08:58:19+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8013d536-491c-58a6-9d7b-7c2f93a64e24

---

Response status code: 200 OK. Responded in 43.194562ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8013d536-491c-58a6-9d7b-7c2f93a64e24",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8013d536-491c-58a6-9d7b-7c2f93a64e24

---

Response status code: 400 Bad Request. Responded in 21.320874ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
...
Response status code: 200 OK. Responded in 9.014543ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/45/events/456"
}
```
...
Response status code: 200 OK. Responded in 8.232622ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/12/events/129"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F45%2Fevents%2F456?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 5.881458ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-12T02:20:17+00:00",
    "endDate": "2020-09-12T04:55:17+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F12%2Fevents%2F129?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 5.338644ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-15T09:57:36+00:00",
    "endDate": "2020-09-15T12:06:36+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e3a633f8-8030-50db-ac07-56fb24de6889

---

Response status code: 200 OK. Responded in 30.824724ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e3a633f8-8030-50db-ac07-56fb24de6889",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e3a633f8-8030-50db-ac07-56fb24de6889

---

Response status code: 200 OK. Responded in 148.05146ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:20+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e3a633f8-8030-50db-ac07-56fb24de6889

---

Response status code: 400 Bad Request. Responded in 12.72044ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
