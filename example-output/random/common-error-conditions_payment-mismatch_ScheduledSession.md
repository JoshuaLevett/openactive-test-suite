...
Response status code: 200 OK. Responded in 36.276658ms
```json
{
...
Response status code: 200 OK. Responded in 9.988263ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-19T13:18:50+00:00",
    "endDate": "2020-09-19T19:02:50+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f974ae51-23fa-58f7-b7c2-a1d4190594e7

---

Response status code: 200 OK. Responded in 41.120987ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f974ae51-23fa-58f7-b7c2-a1d4190594e7",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f974ae51-23fa-58f7-b7c2-a1d4190594e7

---

Response status code: 200 OK. Responded in 92.723946ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f974ae51-23fa-58f7-b7c2-a1d4190594e7

---

Response status code: 400 Bad Request. Responded in 111.617832ms
```json
{
  "@context": "https://openactive.io/",
