...
Response status code: 200 OK. Responded in 14.49309ms
```json
{
...
Response status code: 200 OK. Responded in 13.832373ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/36/events/362"
}
```
...
Response status code: 200 OK. Responded in 10.709489ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-20T19:14:16+00:00",
    "endDate": "2020-09-21T00:41:16+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F36%2Fevents%2F362?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 10.161874ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-16T10:41:51+00:00",
    "endDate": "2020-09-16T11:58:51+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/be3f3f29-0ff9-56c0-8d5d-27a38a4b59ed

---

Response status code: 200 OK. Responded in 51.240779ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/be3f3f29-0ff9-56c0-8d5d-27a38a4b59ed",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/be3f3f29-0ff9-56c0-8d5d-27a38a4b59ed

---

Response status code: 400 Bad Request. Responded in 13.113753ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 7.362499ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/96/events/968"
}
```
...
Response status code: 200 OK. Responded in 6.756282ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/33/events/339"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F96%2Fevents%2F968?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 5.634952ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "maximumAttendeeCapacity": 5,
    "remainingAttendeeCapacity": 5,
    "startDate": "2020-09-18T19:09:35+00:00",
    "endDate": "2020-09-19T00:44:35+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F33%2Fevents%2F339?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 5.149838ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-19T02:59:48+00:00",
    "endDate": "2020-09-19T04:28:48+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a5cc02d7-2549-5f1f-9839-75753fb24664

---

Response status code: 200 OK. Responded in 64.776238ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a5cc02d7-2549-5f1f-9839-75753fb24664",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a5cc02d7-2549-5f1f-9839-75753fb24664

---

Response status code: 200 OK. Responded in 68.404829ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a5cc02d7-2549-5f1f-9839-75753fb24664

---

Response status code: 400 Bad Request. Responded in 15.163705ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
