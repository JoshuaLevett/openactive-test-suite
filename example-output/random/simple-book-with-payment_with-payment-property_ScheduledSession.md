...
Response status code: 200 OK. Responded in 113.613351ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/51/events/510"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/5c6942b1-da46-5912-b215-2ebe40bbc37c

---

Response status code: 204 No Content. Responded in 46.043383ms

## Get Opportunity Feed Items

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F51%2Fevents%2F510?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 22.797192ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-17T11:25:25+00:00",
    "endDate": "2020-09-17T16:29:25+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5c6942b1-da46-5912-b215-2ebe40bbc37c

---

Response status code: 200 OK. Responded in 76.435975ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5c6942b1-da46-5912-b215-2ebe40bbc37c",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5c6942b1-da46-5912-b215-2ebe40bbc37c

---

Response status code: 200 OK. Responded in 87.85347ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:26+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5c6942b1-da46-5912-b215-2ebe40bbc37c

---

Response status code: 200 OK. Responded in 88.410184ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/5c6942b1-da46-5912-b215-2ebe40bbc37c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5c6942b1-da46-5912-b215-2ebe40bbc37c#/orderedItems/69",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/51#/offers/0",
        "price": 4.65,
