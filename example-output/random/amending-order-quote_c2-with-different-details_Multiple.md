...
⚠️ 21 passed with 0 failures, 271 warnings and 102 suggestions 
...
Response status code: 200 OK. Responded in 23.980972ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/56/events/569"
}
```
...
Response status code: 200 OK. Responded in 23.334955ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/8/events/81"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F56%2Fevents%2F569?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 18.445518ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-13T22:52:01+00:00",
    "endDate": "2020-09-13T23:57:01+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F8%2Fevents%2F81?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 17.8248ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-15T18:42:47+00:00",
    "endDate": "2020-09-15T21:47:47+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6c8be108-6d73-5a94-97d1-fc177d2eacb7

---

Response status code: 200 OK. Responded in 81.496469ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6c8be108-6d73-5a94-97d1-fc177d2eacb7",
...
Response status code: 200 OK. Responded in 28.37389ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/33/events/331"
}
```
...
Response status code: 200 OK. Responded in 17.26188ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/40/events/406"
}
```
...
### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F33%2Fevents%2F331?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 29.784429ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-12T06:57:11+00:00",
    "endDate": "2020-09-12T07:54:11+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F40%2Fevents%2F406?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 29.09541ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-18T02:40:06+00:00",
    "endDate": "2020-09-18T06:28:06+00:00"
  }
}
```
### Specs
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6c8be108-6d73-5a94-97d1-fc177d2eacb7

---

Response status code: 200 OK. Responded in 90.936732ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:14+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6c8be108-6d73-5a94-97d1-fc177d2eacb7

---

Response status code: 200 OK. Responded in 62.099817ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/6c8be108-6d73-5a94-97d1-fc177d2eacb7",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6c8be108-6d73-5a94-97d1-fc177d2eacb7#/orderedItems/22",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/33#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6c8be108-6d73-5a94-97d1-fc177d2eacb7#/orderedItems/23",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/33#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6c8be108-6d73-5a94-97d1-fc177d2eacb7#/orderedItems/24",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/40#/offers/0",
        "price": 14.87,
