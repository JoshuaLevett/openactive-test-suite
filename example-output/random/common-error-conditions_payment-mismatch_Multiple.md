...
⚠️ 9 passed with 0 failures, 153 warnings and 60 suggestions 
...
Response status code: 200 OK. Responded in 9.153941ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/58/events/580"
}
```
...
Response status code: 200 OK. Responded in 8.552025ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/32/events/321"
}
```
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F58%2Fevents%2F580?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 17.710865ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-21T00:29:06+00:00",
    "endDate": "2020-09-21T05:43:06+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F32%2Fevents%2F321?useCacheIfAvailable=true

---

Response status code: 200 OK. Responded in 17.250753ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
    ...
    "startDate": "2020-09-17T23:12:51+00:00",
    "endDate": "2020-09-18T00:12:51+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0774297e-1d1d-5f06-9499-45f702ecbeff

---

Response status code: 200 OK. Responded in 57.650615ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0774297e-1d1d-5f06-9499-45f702ecbeff",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0774297e-1d1d-5f06-9499-45f702ecbeff

---

Response status code: 200 OK. Responded in 167.938687ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/0774297e-1d1d-5f06-9499-45f702ecbeff

---

Response status code: 400 Bad Request. Responded in 46.964227ms
```json
{
  "@context": "https://openactive.io/",
