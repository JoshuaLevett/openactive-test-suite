...
Response status code: 200 OK. Responded in 89.536599ms
```json
{
...
Response status code: 200 OK. Responded in 279.628319ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/150/events/1050",
  "modified": 1599820495613,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/150/events/1050",
    ...
    "startDate": "2020-09-12T10:34:54+00:00",
    "endDate": "2020-09-12T11:34:54+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/79fb171c-c52b-55d7-8070-18471cd7e9ab

---

Response status code: 200 OK. Responded in 28.227166ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/79fb171c-c52b-55d7-8070-18471cd7e9ab",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/79fb171c-c52b-55d7-8070-18471cd7e9ab

---

Response status code: 200 OK. Responded in 54.798251ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:55+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/79fb171c-c52b-55d7-8070-18471cd7e9ab

---

Response status code: 400 Bad Request. Responded in 68.604206ms
```json
{
  "@context": "https://openactive.io/",
