...
Response status code: 200 OK. Responded in 22.940137ms
```json
{
...
Response status code: 200 OK. Responded in 31.890434ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 339.874658ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/148/events/1048",
  "modified": 1599820495298,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/148/events/1048",
...
Response status code: 200 OK. Responded in 339.333166ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/149/events/1049",
  "modified": 1599820495299,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/149/events/1049",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/90a91cf9-4ee1-552e-9d7d-9a7c9cf43018

---

Response status code: 200 OK. Responded in 69.054614ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/90a91cf9-4ee1-552e-9d7d-9a7c9cf43018",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/90a91cf9-4ee1-552e-9d7d-9a7c9cf43018

---

Response status code: 200 OK. Responded in 117.013814ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
