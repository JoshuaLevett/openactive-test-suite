...
Response status code: 200 OK. Responded in 59.566725ms
```json
{
...
Response status code: 200 OK. Responded in 56.254851ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 504.599585ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/135/events/1035",
  "modified": 1599820492184,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/135/events/1035",
...
Response status code: 200 OK. Responded in 498.471033ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/134/events/1034",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/21a88f98-342d-590c-b998-a68da10ddb4f

---

Response status code: 200 OK. Responded in 70.500775ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/21a88f98-342d-590c-b998-a68da10ddb4f",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/21a88f98-342d-590c-b998-a68da10ddb4f

---

Response status code: 400 Bad Request. Responded in 20.099002ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 31.943706ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 32.941175ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 427.341827ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/140/events/1040",
  "modified": 1599820493550,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/140/events/1040",
...
Response status code: 200 OK. Responded in 426.94906ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/141/events/1041",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1424c041-f49d-5c89-a43f-8e579d825c07

---

Response status code: 200 OK. Responded in 36.599895ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1424c041-f49d-5c89-a43f-8e579d825c07",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1424c041-f49d-5c89-a43f-8e579d825c07

---

Response status code: 200 OK. Responded in 44.810584ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:52+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1424c041-f49d-5c89-a43f-8e579d825c07

---

Response status code: 400 Bad Request. Responded in 17.426414ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
