[< Return to Summary](summary.md) | File Generated: Fri Sep 11 2020 10:34:52 GMT+0000 (Coordinated Universal Time)
...
Response status code: 200 OK. Responded in 61.40187ms
```json
{
...
Response status code: 200 OK. Responded in 36.955681ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 368.705567ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/147/events/1047",
  "modified": 1599820494724,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/147/events/1047",
    ...
    "startDate": "2020-09-12T10:34:53+00:00",
    "endDate": "2020-09-12T11:34:53+00:00"
  }
}
```
...
Response status code: 200 OK. Responded in 367.35384ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/146/events/1046",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/939759e3-cf54-582d-9c55-8a63a6e5018e

---

Response status code: 200 OK. Responded in 74.631536ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/939759e3-cf54-582d-9c55-8a63a6e5018e",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/939759e3-cf54-582d-9c55-8a63a6e5018e

---

Response status code: 200 OK. Responded in 72.555292ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:54+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/939759e3-cf54-582d-9c55-8a63a6e5018e

---

Response status code: 200 OK. Responded in 78.712058ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/939759e3-cf54-582d-9c55-8a63a6e5018e",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/939759e3-cf54-582d-9c55-8a63a6e5018e#/orderedItems/136",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/147#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/939759e3-cf54-582d-9c55-8a63a6e5018e#/orderedItems/137",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/147#/offers/0",
        "price": 0,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/939759e3-cf54-582d-9c55-8a63a6e5018e#/orderedItems/138",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/146#/offers/0",
        "price": 0,
