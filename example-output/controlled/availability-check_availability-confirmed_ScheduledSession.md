...
Response status code: 200 OK. Responded in 39.629407ms
```json
{
...
Response status code: 200 OK. Responded in 502.63077ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/143/events/1043",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/24a8eb8b-584f-57a3-b114-7db130c4844e

---

Response status code: 200 OK. Responded in 25.183912ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/24a8eb8b-584f-57a3-b114-7db130c4844e",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/24a8eb8b-584f-57a3-b114-7db130c4844e

---

Response status code: 200 OK. Responded in 73.762537ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
