[< Return to Summary](summary.md) | File Generated: Fri Sep 11 2020 10:34:55 GMT+0000 (Coordinated Universal Time)
...
Response status code: 200 OK. Responded in 30.583838ms
```json
{
...
Response status code: 200 OK. Responded in 27.359117ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 449.313397ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/156/events/1056",
...
Response status code: 200 OK. Responded in 446.492343ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/155/events/1055",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/03ec2366-2425-5195-888c-be8c427d8e67

---

Response status code: 200 OK. Responded in 44.091936ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/03ec2366-2425-5195-888c-be8c427d8e67",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/03ec2366-2425-5195-888c-be8c427d8e67

---

Response status code: 200 OK. Responded in 88.06289ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:58+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/03ec2366-2425-5195-888c-be8c427d8e67

---

Response status code: 400 Bad Request. Responded in 53.728974ms
```json
{
  "@context": "https://openactive.io/",
