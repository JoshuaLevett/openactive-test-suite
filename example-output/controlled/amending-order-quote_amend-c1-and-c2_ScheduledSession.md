...
Response status code: 200 OK. Responded in 334.158333ms
```json
{
...
Response status code: 200 OK. Responded in 284.38478ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/101/events/1001",
  "modified": 1599820483268,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/101/events/1001",
    ...
    "duration": "PT1H0.0000036S",
    "maximumAttendeeCapacity": 10,
    "remainingAttendeeCapacity": 10,
    "startDate": "2020-09-12T10:34:41+00:00",
    "endDate": "2020-09-12T11:34:41+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/148b6436-d14a-5360-9aa6-823d0653bd0d

---

Response status code: 200 OK. Responded in 33.633825ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/148b6436-d14a-5360-9aa6-823d0653bd0d",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/148b6436-d14a-5360-9aa6-823d0653bd0d

---

Response status code: 200 OK. Responded in 73.282331ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:43+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
Response status code: 200 OK. Responded in 23.868504ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 320.614803ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/106/events/1006",
  "modified": 1599820484485,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/106/events/1006",
    ...
    "maximumAttendeeCapacity": 10,
    "remainingAttendeeCapacity": 10,
    "startDate": "2020-09-12T10:34:43+00:00",
    "endDate": "2020-09-12T11:34:43+00:00"
  }
}
```
### Specs
...
Response status code: 200 OK. Responded in 32.620656ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 46.41886ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/148b6436-d14a-5360-9aa6-823d0653bd0d

---

Response status code: 200 OK. Responded in 59.950013ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/148b6436-d14a-5360-9aa6-823d0653bd0d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/148b6436-d14a-5360-9aa6-823d0653bd0d#/orderedItems/82",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/106#/offers/0",
        "price": 14.99,
