[< Return to Summary](summary.md) | File Generated: Fri Sep 11 2020 10:34:48 GMT+0000 (Coordinated Universal Time)
...
Response status code: 200 OK. Responded in 26.177237ms
```json
{
...
Response status code: 200 OK. Responded in 15.525091ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 460.221666ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/137/events/1037",
  "modified": 1599820492203,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/137/events/1037",
    ...
    "startDate": "2020-09-12T10:34:50+00:00",
    "endDate": "2020-09-12T11:34:50+00:00"
  }
}
```
...
Response status code: 200 OK. Responded in 458.352144ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/136/events/1036",
  "modified": 1599820492201,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/136/events/1036",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0a1d545b-0950-5413-8aee-ce5a80247618

---

Response status code: 400 Bad Request. Responded in 14.172327ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 38.694527ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 37.274485ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 276.837116ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/138/events/1038",
  "modified": 1599820492961,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/138/events/1038",
    ...
    "maximumAttendeeCapacity": 10,
    "remainingAttendeeCapacity": 10,
    "startDate": "2020-09-12T10:34:51+00:00",
    "endDate": "2020-09-12T11:34:51+00:00"
  }
}
```
...
Response status code: 200 OK. Responded in 276.873422ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/139/events/1039",
  "modified": 1599820492966,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/139/events/1039",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4e761cb8-dd2a-5b35-b433-07c4d10ac959

---

Response status code: 200 OK. Responded in 69.758106ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4e761cb8-dd2a-5b35-b433-07c4d10ac959",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4e761cb8-dd2a-5b35-b433-07c4d10ac959

---

Response status code: 400 Bad Request. Responded in 10.427865ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
...
Response status code: 200 OK. Responded in 11.559656ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 15.376002ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 458.527305ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/144/events/1044",
  "modified": 1599820493972,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/144/events/1044",
    ...
    "maximumAttendeeCapacity": 10,
    "remainingAttendeeCapacity": 10,
    "startDate": "2020-09-12T10:34:52+00:00",
    "endDate": "2020-09-12T11:34:52+00:00"
  }
}
```
...
Response status code: 200 OK. Responded in 458.008117ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/145/events/1045",
  "modified": 1599820493973,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/145/events/1045",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a0e3c687-9dcc-50fa-b892-e3c49d5f8540

---

Response status code: 200 OK. Responded in 90.217689ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a0e3c687-9dcc-50fa-b892-e3c49d5f8540",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a0e3c687-9dcc-50fa-b892-e3c49d5f8540

---

Response status code: 200 OK. Responded in 101.235231ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:53+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a0e3c687-9dcc-50fa-b892-e3c49d5f8540

---

Response status code: 400 Bad Request. Responded in 13.463725ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
