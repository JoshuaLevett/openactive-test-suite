...
Response status code: 200 OK. Responded in 161.676272ms
```json
{
...
Response status code: 200 OK. Responded in 187.643049ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/102/events/1002",
  "modified": 1599820483278,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/102/events/1002",
    ...
    "duration": "PT1H0.0000031S",
    "maximumAttendeeCapacity": 10,
    "remainingAttendeeCapacity": 10,
    "startDate": "2020-09-12T10:34:42+00:00",
    "endDate": "2020-09-12T11:34:42+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d88c3804-9f4c-531d-b3e0-e7774a43901d

---

Response status code: 200 OK. Responded in 51.50144ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d88c3804-9f4c-531d-b3e0-e7774a43901d",
...
Response status code: 200 OK. Responded in 29.194209ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 282.861079ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/107/events/1007",
...
Response status code: 200 OK. Responded in 35.404281ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d88c3804-9f4c-531d-b3e0-e7774a43901d

---

Response status code: 200 OK. Responded in 32.186374ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d88c3804-9f4c-531d-b3e0-e7774a43901d

---

Response status code: 200 OK. Responded in 74.600678ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d88c3804-9f4c-531d-b3e0-e7774a43901d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d88c3804-9f4c-531d-b3e0-e7774a43901d#/orderedItems/81",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/107#/offers/0",
        "price": 14.99,
