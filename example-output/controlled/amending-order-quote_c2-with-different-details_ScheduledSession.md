...
Response status code: 200 OK. Responded in 115.982658ms
```json
{
...
Response status code: 200 OK. Responded in 70.083489ms
```json
{
  "data": {
    "@context": "https://openactive.io/",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cac54d34-7cb2-51b7-a9d7-8b954eb45239

---

Response status code: 200 OK. Responded in 47.912654ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/cac54d34-7cb2-51b7-a9d7-8b954eb45239",
...
Response status code: 200 OK. Responded in 29.827299ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 38.939739ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/105/events/1005",
  "modified": 1599820483876,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/105/events/1005",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cac54d34-7cb2-51b7-a9d7-8b954eb45239

---

Response status code: 200 OK. Responded in 96.58686ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/cac54d34-7cb2-51b7-a9d7-8b954eb45239

---

Response status code: 200 OK. Responded in 48.463546ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/cac54d34-7cb2-51b7-a9d7-8b954eb45239",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cac54d34-7cb2-51b7-a9d7-8b954eb45239#/orderedItems/78",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/105#/offers/0",
        "price": 14.99,
