...
Response status code: 200 OK. Responded in 76.402418ms
```json
{
...
Response status code: 200 OK. Responded in 88.521805ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 373.637409ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/108/events/1008",
  "modified": 1599820484915,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/108/events/1008",
...
Response status code: 200 OK. Responded in 373.371959ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/109/events/1009",
  "modified": 1599820484916,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/109/events/1009",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b68b05d5-f738-5007-bb17-05fc0786f4bc

---

Response status code: 200 OK. Responded in 52.329755ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b68b05d5-f738-5007-bb17-05fc0786f4bc",
...
Response status code: 200 OK. Responded in 73.400283ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 36.798459ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 490.073735ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/115/events/1015",
  "modified": 1599820486010,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/115/events/1015",
...
Response status code: 200 OK. Responded in 489.524232ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/116/events/1016",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b68b05d5-f738-5007-bb17-05fc0786f4bc

---

Response status code: 200 OK. Responded in 51.012093ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b68b05d5-f738-5007-bb17-05fc0786f4bc

---

Response status code: 200 OK. Responded in 80.887295ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b68b05d5-f738-5007-bb17-05fc0786f4bc",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b68b05d5-f738-5007-bb17-05fc0786f4bc#/orderedItems/91",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/115#/offers/0",
        "price": 14.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b68b05d5-f738-5007-bb17-05fc0786f4bc#/orderedItems/92",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/115#/offers/0",
        "price": 14.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b68b05d5-f738-5007-bb17-05fc0786f4bc#/orderedItems/93",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/116#/offers/0",
        "price": 14.99,
