...
Response status code: 200 OK. Responded in 71.951676ms
```json
{
...
Response status code: 200 OK. Responded in 184.270819ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/126/events/1026",
  "modified": 1599820489798,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/126/events/1026",
    ...
    "startDate": "2020-09-12T10:34:48+00:00",
    "endDate": "2020-09-12T11:34:48+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b16f46d4-b5aa-5de2-82fe-fff439f38cd2

---

Response status code: 400 Bad Request. Responded in 10.482461ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 9.895757ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 401.839608ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/129/events/1029",
  "modified": 1599820490396,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/129/events/1029",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a4c614e0-2e00-5caf-a8a3-775ad886eb71

---

Response status code: 200 OK. Responded in 26.843009ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a4c614e0-2e00-5caf-a8a3-775ad886eb71",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a4c614e0-2e00-5caf-a8a3-775ad886eb71

---

Response status code: 400 Bad Request. Responded in 24.480195ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
...
Response status code: 200 OK. Responded in 34.689785ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 471.297583ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/130/events/1030",
  "modified": 1599820491290,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/130/events/1030",
    ...
    "maximumAttendeeCapacity": 10,
    "remainingAttendeeCapacity": 10,
    "startDate": "2020-09-12T10:34:49+00:00",
    "endDate": "2020-09-12T11:34:49+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b72bb8d4-f524-5ee7-81d5-49f667b5c6c2

---

Response status code: 200 OK. Responded in 29.164156ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b72bb8d4-f524-5ee7-81d5-49f667b5c6c2",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b72bb8d4-f524-5ee7-81d5-49f667b5c6c2

---

Response status code: 200 OK. Responded in 83.453366ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:50+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b72bb8d4-f524-5ee7-81d5-49f667b5c6c2

---

Response status code: 400 Bad Request. Responded in 15.390268ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
