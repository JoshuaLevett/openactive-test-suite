...
Response status code: 200 OK. Responded in 39.632888ms
```json
{
...
Response status code: 200 OK. Responded in 36.345475ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 354.312147ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/112/events/1012",
  "modified": 1599820485462,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/112/events/1012",
...
Response status code: 200 OK. Responded in 352.803665ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/111/events/1011",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/34169dbb-ad34-50b0-9a7d-be7540c3c134

---

Response status code: 200 OK. Responded in 44.211642ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/34169dbb-ad34-50b0-9a7d-be7540c3c134",
...
Response status code: 200 OK. Responded in 23.791035ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 29.150733ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 470.699586ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/119/events/1019",
  "modified": 1599820486383,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/119/events/1019",
...
Response status code: 200 OK. Responded in 470.309512ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/120/events/1020",
...
Response status code: 200 OK. Responded in 42.601144ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/34169dbb-ad34-50b0-9a7d-be7540c3c134

---

Response status code: 200 OK. Responded in 107.383574ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:45+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/34169dbb-ad34-50b0-9a7d-be7540c3c134

---

Response status code: 200 OK. Responded in 104.244263ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/34169dbb-ad34-50b0-9a7d-be7540c3c134",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/34169dbb-ad34-50b0-9a7d-be7540c3c134#/orderedItems/100",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/119#/offers/0",
        "price": 14.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/34169dbb-ad34-50b0-9a7d-be7540c3c134#/orderedItems/101",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/119#/offers/0",
        "price": 14.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/34169dbb-ad34-50b0-9a7d-be7540c3c134#/orderedItems/102",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/120#/offers/0",
        "price": 14.99,
