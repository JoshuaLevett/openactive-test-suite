[< Return to Summary](summary.md) | File Generated: Fri Sep 11 2020 10:34:46 GMT+0000 (Coordinated Universal Time)
...
Response status code: 200 OK. Responded in 87.794139ms
```json
{
...
DELETE https://localhost:5001/api/openbooking/orders/99e9209b-bb5a-5bfa-802c-7eb1ed69a665

---

Response status code: 204 No Content. Responded in 41.883273ms
...
Response status code: 200 OK. Responded in 96.866309ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/125/events/1025",
  "modified": 1599820488162,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/125/events/1025",
    ...
    "startDate": "2020-09-12T10:34:47+00:00",
    "endDate": "2020-09-12T11:34:47+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/99e9209b-bb5a-5bfa-802c-7eb1ed69a665

---

Response status code: 200 OK. Responded in 45.131811ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/99e9209b-bb5a-5bfa-802c-7eb1ed69a665",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/99e9209b-bb5a-5bfa-802c-7eb1ed69a665

---

Response status code: 200 OK. Responded in 332.619486ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:48+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/99e9209b-bb5a-5bfa-802c-7eb1ed69a665

---

Response status code: 200 OK. Responded in 59.314632ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/99e9209b-bb5a-5bfa-802c-7eb1ed69a665",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/99e9209b-bb5a-5bfa-802c-7eb1ed69a665#/orderedItems/113",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/125#/offers/0",
        "price": 14.99,
...
### get-order Request
GET http://localhost:3000/get-order/99e9209b-bb5a-5bfa-802c-7eb1ed69a665

---

Response status code: 200 OK. Responded in 2605.939633ms
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "99e9209b-bb5a-5bfa-802c-7eb1ed69a665",
  "modified": 637354172886976000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/99e9209b-bb5a-5bfa-802c-7eb1ed69a665",
    "identifier": "99e9209b-bb5a-5bfa-802c-7eb1ed69a665",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/99e9209b-bb5a-5bfa-802c-7eb1ed69a665#/orderedItems/113",
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/99e9209b-bb5a-5bfa-802c-7eb1ed69a665

---

Response status code: 204 No Content. Responded in 24.957732ms
### Specs
