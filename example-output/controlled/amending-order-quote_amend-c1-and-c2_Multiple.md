[< Return to Summary](summary.md) | File Generated: Fri Sep 11 2020 10:34:41 GMT+0000 (Coordinated Universal Time)
...
Response status code: 200 OK. Responded in 54.34203ms
```json
{
...
Response status code: 200 OK. Responded in 47.389134ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 297.665488ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/114/events/1014",
  "modified": 1599820485463,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/114/events/1014",
    ...
    "startDate": "2020-09-12T10:34:44+00:00",
    "endDate": "2020-09-12T11:34:44+00:00"
  }
}
```
...
Response status code: 200 OK. Responded in 295.231834ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/113/events/1013",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/eb5e0741-47ac-5939-821d-dea7bf7ac3f3

---

Response status code: 200 OK. Responded in 96.666419ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/eb5e0741-47ac-5939-821d-dea7bf7ac3f3",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/eb5e0741-47ac-5939-821d-dea7bf7ac3f3

---

Response status code: 200 OK. Responded in 37.543699ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:44+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
Response status code: 200 OK. Responded in 14.475565ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 20.215022ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 441.880969ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/121/events/1021",
  "modified": 1599820486558,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/121/events/1021",
    ...
    "maximumAttendeeCapacity": 10,
    "remainingAttendeeCapacity": 10,
    "startDate": "2020-09-12T10:34:45+00:00",
    "endDate": "2020-09-12T11:34:45+00:00"
  }
}
```
...
Response status code: 200 OK. Responded in 441.5002ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/122/events/1022",
...
Response status code: 200 OK. Responded in 56.957188ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
Response status code: 200 OK. Responded in 155.502388ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:46+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/eb5e0741-47ac-5939-821d-dea7bf7ac3f3

---

Response status code: 200 OK. Responded in 138.512997ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/eb5e0741-47ac-5939-821d-dea7bf7ac3f3",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/eb5e0741-47ac-5939-821d-dea7bf7ac3f3#/orderedItems/109",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/121#/offers/0",
        "price": 14.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/eb5e0741-47ac-5939-821d-dea7bf7ac3f3#/orderedItems/110",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/121#/offers/0",
        "price": 14.99,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/eb5e0741-47ac-5939-821d-dea7bf7ac3f3#/orderedItems/111",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/122#/offers/0",
        "price": 14.99,
