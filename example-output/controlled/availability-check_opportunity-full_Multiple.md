[< Return to Summary](summary.md) | File Generated: Fri Sep 11 2020 10:34:56 GMT+0000 (Coordinated Universal Time)
...
Response status code: 200 OK. Responded in 22.517151ms
```json
{
...
Response status code: 200 OK. Responded in 20.799281ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 274.026021ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/160/events/1060",
  "modified": 1599820499470,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/160/events/1060",
    ...
    "duration": "PT1H0.0000015S",
    "maximumAttendeeCapacity": 0,
    "remainingAttendeeCapacity": 0,
    "startDate": "2020-09-12T10:34:58+00:00",
    "endDate": "2020-09-12T11:34:58+00:00"
  }
}
```
...
Response status code: 200 OK. Responded in 272.471576ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/159/events/1059",
  "modified": 1599820499465,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/159/events/1059",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d049422a-88bb-58b5-b444-fb0d64f3fff5

---

Response status code: 409 Conflict. Responded in 83.728606ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d049422a-88bb-58b5-b444-fb0d64f3fff5",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d049422a-88bb-58b5-b444-fb0d64f3fff5

---

Response status code: 409 Conflict. Responded in 115.283273ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:59+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
