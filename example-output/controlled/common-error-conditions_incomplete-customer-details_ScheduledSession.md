...
Response status code: 200 OK. Responded in 47.895204ms
```json
{
...
Response status code: 200 OK. Responded in 496.269386ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/127/events/1027",
  "modified": 1599820490395,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/127/events/1027",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/23a749e4-b9ff-5b63-9cbe-74e9d32a8e70

---

Response status code: 200 OK. Responded in 71.08117ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/23a749e4-b9ff-5b63-9cbe-74e9d32a8e70",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/23a749e4-b9ff-5b63-9cbe-74e9d32a8e70

---

Response status code: 400 Bad Request. Responded in 13.230621ms
```json
{
  "@context": "https://openactive.io/",
...
Response status code: 200 OK. Responded in 11.938494ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
Response status code: 200 OK. Responded in 382.477997ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/131/events/1031",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7eb49073-0eba-5284-a59a-3fa97c7b1c3f

---

Response status code: 200 OK. Responded in 24.140585ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7eb49073-0eba-5284-a59a-3fa97c7b1c3f",
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/131"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10,
        "startDate": "2020-09-12T10:34:49+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7eb49073-0eba-5284-a59a-3fa97c7b1c3f

---

Response status code: 200 OK. Responded in 32.13237ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7eb49073-0eba-5284-a59a-3fa97c7b1c3f

---

Response status code: 400 Bad Request. Responded in 37.526005ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
