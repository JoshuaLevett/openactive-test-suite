...
Response status code: 200 OK. Responded in 78.276937ms
```json
{
...
Response status code: 200 OK. Responded in 463.634612ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/154/events/1054",
  "modified": 1599820498288,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/154/events/1054",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/95fd949f-4fc2-5096-bd52-e5985f79095e

---

Response status code: 409 Conflict. Responded in 84.994563ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/95fd949f-4fc2-5096-bd52-e5985f79095e",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/95fd949f-4fc2-5096-bd52-e5985f79095e

---

Response status code: 409 Conflict. Responded in 99.093213ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2020-09-11T10:39:57+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
