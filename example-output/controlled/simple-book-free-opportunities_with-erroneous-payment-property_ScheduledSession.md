...
Response status code: 200 OK. Responded in 82.130216ms
```json
{
...
Response status code: 200 OK. Responded in 365.536011ms
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/151/events/1051",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fbdcabbd-0128-5ac1-a863-3313819602f5

---

Response status code: 200 OK. Responded in 81.872118ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fbdcabbd-0128-5ac1-a863-3313819602f5",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fbdcabbd-0128-5ac1-a863-3313819602f5

---

Response status code: 200 OK. Responded in 77.282276ms
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/fbdcabbd-0128-5ac1-a863-3313819602f5

---

Response status code: 400 Bad Request. Responded in 44.096319ms
```json
{
  "@context": "https://openactive.io/",
